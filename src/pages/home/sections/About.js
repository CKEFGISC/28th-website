  ...
  return (
    <section id="about">
      <div className="container">
        <div className="row">
          <div className="section-title col-md-8 offset-md-2 text-center"> <div>關於我們</div> </div>
        </div>
        <div className="row">
          <div className="text-paragraph">
            <h3>關於建北電資</h3>
            <h4 className="tab-1"><li>社史</li></h4>
            <div className="tab-5">
              好奇乃人類之天性，知識是實現夢想之道，而真理則是心靈最安寧的歸宿
              <br /><div className="mb-2"></div>
              ...
              在常人來看，建北電資根本就是同一個社團
              <br /><div className="mb-4"></div>
            </div>
            <h4 className="tab-1"><li>吉祥物</li></h4>
            <div className="tab-5 d-flex">
              <img src="/images/chicken.png" height="120" alt="Chicken" />
              <div>
